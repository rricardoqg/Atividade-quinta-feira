/**
 * ============================================================
 * JRK USINAGEM — script.js
 * Professional Industrial Landing Page
 * ============================================================
 */
...
const Parallax = (() => {
  ...
  function init() {
    // Only enable parallax on non-mobile for performance
...
/* ============================================================
   10. ACTIVE NAV LINK — highlight current section
   ============================================================ */
const ActiveNav = (() => {
  function init() {
...
/* ============================================================
   11. HERO TITLE LINE ANIMATION — wraps text in spans
   ============================================================ */
const HeroAnimation = (() => {
  function init() {
    ...
    titleLines.forEach(line => {
      // Already has a child span from HTML? use it. Otherwise wrap.
...
/* ============================================================
   12. CARD STAGGER — delay each service card reveal
   ============================================================ */
const CardStagger = (() => {
  function init() {
...
/* ============================================================
   13. PERFORMANCE — prefers-reduced-motion check
   ============================================================ */
function checkReducedMotion() {
  if (window.matchMedia('(prefers-reduced-motion: reduce)').matches) {
    ...
    // Mark all reveals as already visible
...
/* ============================================================
   14. NAVBAR HEIGHT CSS VAR — update on resize for accurate offset
   ============================================================ */
...
/* ============================================================
   15. INIT — kick everything off on DOMContentLoaded
   ============================================================ */
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ------- Micro-interaction: cursor glow on service cards ------- */
  ...
  /* ------- Lazy-set active style for nav links ------- */
  ...
  /* ------- Stagger diff cards ------- */
  document.querySelectorAll('.diff-card.reveal').forEach((card, i) => {
    if (!card.hasAttribute('data-delay')) {
      card.setAttribute('data-delay', String(i * 60));
    }
  });

  /* ------- Gallery items stagger ------- */
  document.querySelectorAll('.gallery-item.reveal').forEach((item, i) => {
    if (!item.hasAttribute('data-delay')) {
      item.setAttribute('data-delay', String(i * 80));
    }
  });

  console.log('%c JRK Usinagem ', 'background:#FFB800;color:#000;font-weight:bold;padding:4px 12px;border-radius:4px;', '— Site carregado com sucesso!');
});
